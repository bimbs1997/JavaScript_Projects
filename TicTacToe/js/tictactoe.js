...
function placeXorO(squareNumber) {
    ...
    //the .som() method is used to check each element of selectedSquare array to
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This function plays placements sound.
        ...
        //Returning true is needed for our computerTurn() function work.
        return true;
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start on alines x axis is.
    let x1 = coordX1,
    ...
    //This line disallows clicking while the win sound playing 
    disableClick();
    ...
    function resetGame() {
        ...
        for (let i = 0; i< 9; i++) {
            //This variable gets the html elemt of i.
