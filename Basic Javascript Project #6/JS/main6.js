function Verify_function() {        //defines the ternary operation using input from the browser
    var Age, Can_verify;
...
function vehicle (Make, Model, Year, Color) {       //defines the this keyword fuction.
...
var Blake = new vehicle ("Ferrari", "Italia", 2020, "Red");         //defines the new keyword and fuction.
